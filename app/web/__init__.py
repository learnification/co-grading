...
from app.web.endpoints import assignment_views, documents_views, score_views, highlight_views, feedback_views, tutorial_views
...
app.include_router(tutorial_views.router, prefix="/api/v1/tutorial", tags=["tutorial"])
app.add_middleware(
    CORSMiddleware,
