...
def test_success(mocker, mock_generate_feedback, mock_validate):
    ...
    expected_feedbacks = {
        388778: {"submission_id": 57658105, "score": 8.0, "feedback": "Good understanding with minor omissions."},
        389291: {"submission_id": 51344183, "score": 9.0, "feedback": "Clear definition with accurate distinctions."},
    }
